...
public class CreateEventTests(IntegrationTestWebAppFactory factory) : BaseIntegrationTest(factory)
{
    public static readonly TheoryData<Guid, string, string, string, DateTime, DateTime?> InvalidData = new()
    {
        ...
        { Guid.NewGuid(), string.Empty, Faker.Music.Genre(), Faker.Address.StreetAddress(), default, null },
        { Guid.NewGuid(), Faker.Music.Genre(), string.Empty, Faker.Address.StreetAddress(), default, null },
        { Guid.NewGuid(), Faker.Music.Genre(), Faker.Music.Genre(), string.Empty, default, null },
        { Guid.NewGuid(), Faker.Music.Genre(), Faker.Music.Genre(), Faker.Address.StreetAddress(), default, null }
    };
