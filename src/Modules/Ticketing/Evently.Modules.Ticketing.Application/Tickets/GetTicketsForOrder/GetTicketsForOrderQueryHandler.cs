...
internal sealed class GetTicketsForOrderQueryHandler(
    ...
    : IQueryHandler<GetTicketsForOrderQuery, IReadOnlyList<TicketResponse>>
{
    public async Task<Result<IReadOnlyList<TicketResponse>>> Handle(GetTicketsForOrderQuery request, CancellationToken cancellationToken)
    {
