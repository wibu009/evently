...
namespace Evently.Modules.Attendance.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250531182950_Add_Outbox_Message_And_Outbox_Message_Consumer_Tables")]
    partial class Add_Outbox_Message_And_Outbox_Message_Consumer_Tables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Evently.Modules.Attendance.Domain.Tickets.Ticket", b =>
                {
                    b.HasOne("Evently.Modules.Attendance.Domain.Attendees.Attendee", null)
                        .WithOne()
                        .HasForeignKey("Evently.Modules.Attendance.Domain.Tickets.Ticket", "AttendeeId")
                    ...
                    b.HasOne("Evently.Modules.Attendance.Domain.Events.Event", null)
                        .WithOne()
                        .HasForeignKey("Evently.Modules.Attendance.Domain.Tickets.Ticket", "EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
